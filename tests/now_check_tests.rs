...
#[test]
fn now_shows_only_past_and_today_chunks() {
...
#[test]
fn check_pass_when_nothing_due() {
    // file1 modified recently → due in future
    let output = TestHarness::new()
        .init_git(
            "
...
#[test]
fn current_time_zoned_drives_today() {
